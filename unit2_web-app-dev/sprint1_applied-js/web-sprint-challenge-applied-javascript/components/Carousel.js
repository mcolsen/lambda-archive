...
function Carousel(urls){
	...
	leftButton.classList.toggle('left-button');
	...
	rightButton.classList.toggle('right-button');
...
const imageURLs = ['https://tk-assets.lambdaschool.com/ba687af4-3a1e-43d7-87b2-f30453264c9d_mountains.jpeg',
...
document.querySelector('.carousel-container').appendChild(Carousel(imageURLs));